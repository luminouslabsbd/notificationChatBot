const styles = `
    ...
    .ll-list-ui-form-input-container {
        position: relative;
        font-size: 1rem;
        display: flex;
        margin-top: 50px;
    ...
    p.ll-list-allowed-notification {
        font-size: 12px;
        margin: 0;
        padding-top: 8px;
        font-family: sans-serif;
    ...
    label.ll-list-number-felid input {
        padding: 12px;
        border: 1px solid #ddd;
        border-radius: 8px;
        width: 100%;
    ...
    label.ll-subscriber-name-felid {
        position: relative;
        display: flex;
    }

    label.ll-subscriber-name-felid input {
        padding: 13px 15px;
        border-radius: 8px;
        border: 1px solid #ddd;
        outline: 0;
    ...
    span.ll-subscriber-name-placeholder {
        position: absolute;
        top: -7px;
        left: 10px;
        color: #000;
    ...
    select.ll-subscriber-status-select-box {
        padding: 12px;
        border: 1px solid #ddd;
        background-color: transparent;
        border-radius: 8px;
    ...
    .ll-subscriber-ui-form-input-container {
        position: relative;
        font-size: 1rem;
        display: flex;
        margin-top: 50px;
    ...
    .ll-subscriber-form-input-label {
        position: absolute;
        top: -7px;
        left: 10px;
        color: #000;
    ...
    button.ll-subscriber-page-close {
        color: #585656;
        padding: 10px 20px;
        background-color: rgb(218, 214, 221);
        border: none;
    ...
    p.ll-subscriber-allowed-notification {
        font-size: 12px;
        margin: 0;
        padding-top: 8px;
        font-family: sans-serif;
    ...
    .ll-subscriber-select-box option {
        background-color: #f8f9fa;
        color: #212529;
    }

    .ll-subscriber-name-feild-parent {
        margin-top: 20px;
        display: flex;
        align-items: center;
        gap: 20px;
    ...
    .ll-subscriber-status-main {
        position: relative;
    }

    .ll-subscriber-name-main {
        width: 100%;
    }

    p.ll-subscriber-status-notification {
        font-size: 11px;
        margin: 0;
        padding-top: 6px;
        font-family: sans-serif;
    ...
    select.ll-subscriber-number-select-box {
        padding: 12px;
        border: none;
        color: #707070;
        font-size: 13px;
        ...
        box-shadow: rgba(17, 17, 26, 0.1) 0px 1px 0px;
        border-radius: 7px;
        background-color: #cfcccc59;
    }

    .ll-subscriber-number-parent {
        display: flex;
        align-items: center;
        gap: 20px;
        margin-top: 30px;
    ...
    label.ll-subscriber-number-felid input {
        padding: 12px;
        border: 1px solid #b69c0ab5;
        border-radius: 8px;
        /* margin-top: 20px; */
        width: 100%;
        outline: none;
    ...
    label.ll-subscriber-number-felid {
        position: relative;
        display: flex;
    }

    .ll-subscriber-number-main {
        width: 100%;
    }

    .ll-subscriber-list-main {
        margin-top: 30px;
        position: relative;
    }

    span.ll-subscriber-list-placeholder {
        position: absolute;
        top: -7px;
        left: 10px;
        color: #000;
