        ...
        <div class="ll-template-new-system">
            ...
            <div class="ll-template-meassage-area">
                <label class="ll-template-ui-form-input-container">
                    <textarea maxlength="2000" class="ll-template-ui-form-input ll_template_form_data" name="template_text" id="ll_template_text" rows="6" cols="30" placeholder="SMS Message" required></textarea>
            ...
            <div class="ll-template-button">
                <button class="ll-template-save" id="ll_template_save">Save</button>
            </div>
...
function setTemplateTextField(){
    ...
    var element =  document.getElementById('ll_whatsapp_template');
...
function template_submit(){
    ...
    if (typeof(template_form) != 'undefined' && template_form != null){
            ...
            xhr.onreadystatechange = function () {
                if (this.readyState == 4) {
                    ...
                    if(this.status == 200 || this.status == 201){
                        ...
                        thankYouModal('Template Inserted Successfully!');
